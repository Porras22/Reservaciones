...
<input type="number" name="Numerodias" id="d${num}" value="" onblur="CalcularImporte(${num});"/></label>
<label>Cuantos adultos son:
<input type="number" name:"cuantosadultos"  id="a${num}" value="" step="" onblur="CalcularImporte(${num});" /></label>
<label>Cuantos niños son :
<input type="number" name="cuantosniños" id="n${num}  value="" step="" onblur="CalcularImporte(${num});" /></label>
<label>habitacion
<input type="number" name="habitacion" id="h${num}" max:"2" onblur="CalcularImporte(${num});" ></input>
</label>
<label>Importe
<input type="number" name="importe" id="i${num}"  onblur="CalcularImporte(${num});" ></input>
</label>
...
var CalcularImporte=function(x){
   document.getElementById("i"+ x).value=document.getElementById("d"+x).value*document.getElementById("a"+x).value*document.getElementById("h"+x).value;
   calcular();
